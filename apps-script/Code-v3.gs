/* ============================================================
   BACKEND v3 · Control de Cargas Netso
   Acciones: subirDoc · guardarDatosPI · cambiarEstado · crearCarga · leer

   CONFIG — edita estas 3 líneas antes de desplegar
   ============================================================ */
const TOKEN      = "CAMBIA-ESTO";
const FOLDER_ID  = "ID_DE_TU_CARPETA_DE_DRIVE";
...
/* ============================================================
   ACCIÓN · subirDoc   (igual que v2, + soporte para pagoPI)
   ============================================================ */
function subirDoc(p) {
...
function leer() {
  ...
  return { matriz: matriz, links: links, filas: nF - 1, columnas: nC };
}
